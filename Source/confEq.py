...
def confEq(temp, newDensity, run, chkpt_file, pdb_file, cudaIndex, saveFolder):
    ##########################################################################
    # Variables
    ##########################################################################
    ...
    save_baseName = saveFolder + '/confEq' + str(run)        # a string that designates the base save name
